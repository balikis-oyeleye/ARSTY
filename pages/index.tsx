    ...
    <>
      ...
      <section className="container mx-auto my-[50px] space-y-6 px-2 xs:px-0">
        ...
        <div className="lg:w-[928px] mx-auto">
          <p className="font-satoshi font-medium text-base text-dark md:text-[28px] text-center md:leading-[156.7%]">
      ...
      <section className="mt-8 container mx-auto px-2 xs:px-0">
